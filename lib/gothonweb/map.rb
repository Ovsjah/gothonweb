module Map
  ...
  put it in the bridge, and blow the ship up after gettin into an 
  escape pod.
  
  You're running down the central corridor to the Weapons Armory when
  a Gothon jumpls out, red scaly skin, dark grimy teeth, and evil clown costume
  ...
  The pod eadily slides out into space heading to
  ...
  The bod escapes out into the void of space, then
  ...
  GENERIC_DEATH = Room.new("Death", quips[rand(0..(quips.length - 1))])
  ...
  CENTRAL_CORRIDOR.add_paths({
    'player shoot enemy' => GENERIC_DEATH,
    'player dodge enemy' => GENERIC_DEATH,
